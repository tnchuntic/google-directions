...
function mkgd_register_settings() {
    ...
    register_setting('mkgd-settings-group', 'mkgd_origin');
    register_setting('mkgd-settings-group', 'mkgd_origin_hide');
    register_setting('mkgd-settings-group', 'mkgd_destination');
    register_setting('mkgd-settings-group', 'mkgd_destination_hide');
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" value="<?php echo get_option('mkgd_origin', 'Morwell, Australia'); ?>" size="33" name="mkgd_origin">
                                        <br/><input type="checkbox" name="mkgd_origin_hide" value="true" <?php if(get_option('mkgd_origin_hide')) echo 'checked';?>>Hide in front-end.</td>
                                </tr>
                                <tr>
                                    <td><label for="destination">Destination: </label></td>
                                    <td><input type="text" value="<?php echo get_option('mkgd_destination', 'Traralgon, Australia'); ?>" size="33" name="mkgd_destination">
                                        <br/><input type="checkbox" name="mkgd_destination_hide" value="true" <?php if(get_option('mkgd_destination_hide')) echo 'checked';?>>Hide in front-end.</td>
                                </tr>
                                <tr>
                                    <td><label for="latitude">Latitude: </label></td>
                                    <td><input type="text" value="<?php echo get_option('mkgd_latitude', '43.6525'); ?>" size="33" name="mkgd_latitude">
                                        <br/><small>Default latitudes for the Google Map <a href="http://itouchmap.com/latlong.html" title="Help" target="_blank" rel="nofollow"><strong>Help?</strong></a></small></td>
                                </tr>
                                <tr>
                                    <td><label for="longitude">Longitude: </label></td>
                                    <td><input type="text" value="<?php echo get_option('mkgd_longitude', '-79.3816667'); ?>" size="33" name="mkgd_longitude">
                                        <br/><small>Default longitudes for the Google Map <a href="http://itouchmap.com/latlong.html" title="Help" target="_blank" rel="nofollow"><strong>Help?</strong></a></small></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/><small>Default language for the Google Map</small></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/><small>Default unit system for the Google Map</small></td>
                                </tr>
                                <tr>
                                    <td><label for="map-width">Map Width: </label></td>
                                    <td><input type="text" value="<?php echo get_option('mkgd_width', '500'); ?>" size="33" name="mkgd_width">
                                        <br/><small>Default width for the Google Map</small></td>
                                </tr>
                                <tr>
                                    <td><label for="map-width">Map Height: </label></td>
                                    <td><input type="text" value="<?php echo get_option('mkgd_height', '300'); ?>" size="33" name="mkgd_height">
                                        <br/><small>Default height for the Google Map</small></td>
                                </tr>
                            </table>
                        </td>
                        <td>
